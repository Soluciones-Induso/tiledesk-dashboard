...
export class WidgetSharedComponent implements OnInit {
  ...
  languages = [
    ...
    { code: 'az', name: 'Azerbaijani', type: '--- Needs own translation ---' },
    ...
    { code: 'kk', name: 'Kazakh', type: '--- Needs own translation ---' },
    ...
    { code: 'sr', name: 'Serbian', type: '--- Needs own translation ---' },
    ...
    { code: 'sv', name: 'Swedish', type: '--- Needs own translation ---' },
    ...
    { code: 'uk', name: 'Ukrainian', type: '--- Needs own translation ---' },
    { code: 'ur', name: 'Urdu', type: '--- Needs own translation ---' },
    { code: 'uz', name: 'Uzbek', type: '--- Needs own translation ---' },
